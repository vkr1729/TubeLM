...
# tubelm_mac.spec — macOS PyInstaller spec for TubeLM
# Entry point: mac_launcher.py (menu bar status item + Flask GUI)
# Run from desktop/ directory: pyinstaller --clean tubelm_mac.spec
...
a = Analysis(
    ...
    runtime_hooks=[],
    excludes=[
        # Exclude Linux-only and Windows-only modules
        'pystray',
        'Xlib',
        '_winapi',
        'winreg',
